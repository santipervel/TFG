...
archivo_resultados = ruta_script / "resultados_medias_globales_original.csv"  # Cambiar el nombre
output_dir = ruta_script / "Graficas_detector"
output_dir.mkdir(parents=True, exist_ok=True)

# --- Cargar datos ---
df = pd.read_csv(archivo_resultados, sep=";")
usuarios = [
    "logical-coral-pig-warehouseman",
    "monthly-emerald-bug-zoologist"
]
